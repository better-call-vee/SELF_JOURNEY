/*
☞ Better.Call.Vee ☜
created: 11th November, 2023 04:09:20 GMT+6
*/
#include <bits/stdc++.h>
using namespace std;
 ...
 *       /    \
 *      /------\ ধরি, আমরা এই বরাবর কাট করেছি। তাহলে, এর এই অংশ থেকে নীচের অংশ পর্যন্ত
 *     /        \ যে উচ্চতা সেই উচ্চতার একটি ত্রিভুজ কল্পনা করি, যেখানে ওই ত্রিভুজের ভূমি হবে এই ট্রাপিজিয়ামের উপরের
 *    /----------\                                                                                    পার্ট
 *   /____________\ 
